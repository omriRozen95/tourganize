...
for the reason [D15](../../docs/architecture/decisions.md) already recorded once for
``PriorityPolicy``: a port's contract has to name the types it carries, and these two carry
Dialogue value objects — a ``UserTurn``, a ``DialogueState``, a ``PendingQuestion``. The
